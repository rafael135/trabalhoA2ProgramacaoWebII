<div id="editLancheModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="editLancheModal">
            ...
            <!-- Modal body -->
            <form id="formEditLanche" method="PUT"
                enctype="multipart/form-data" class="relative p-4 md:p-5">

                <div id="loadingStatus" class="bg-black/30 absolute top-0 bottom-0 left-0 right-0 justify-center items-center" style="display: none;">
                    <div role="status">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1 w-[160%] min-w-[360px] flex flex-col gap-2">
                        <input id="image" name="image" type="file" accept=".png, .jpg, .jpeg"
                            multiple="false" />
                        <div class="w-[80%] mx-auto p-2 flex justify-center items-center border border-solid border-gray-600/40 rounded-lg">
