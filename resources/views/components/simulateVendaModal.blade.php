<div id="simulateVendaModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    id="simulateVendaModalBtn" data-modal-toggle="simulateVendaModal">
            ...
            <!-- Modal body -->
            <form id="formSimulateVenda" method="POST"
